...
- Does every test method carry a `@DisplayName` annotation with a short, descriptive label (e.g., `@DisplayName("throws when the manager is already registered")`)? The label is a concise description — **not** a Given/When/Then sentence.
